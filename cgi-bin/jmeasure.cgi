...
#echo "Usage: $0 type autoplay size"
#echo "Example: $0 eit_171 1 0"
#echo " "
#echo "Types: eit_171 eit_195 eit_284 eit_304 c2 c3"
#echo "Autoplay: 0=false 1=true"
...
file_type=`echo $form_arg | cut -c11-13 | tr 'A-Z' 'a-z'`
AUTO=`echo $form_arg | cut -c24 `
AUTO=`expr $AUTO + 0`

code1=`echo $form_arg | cut -c31 | tr 'A-Z' 'a-z'`
code2=`echo $form_arg | cut -c32 | tr 'A-Z' 'a-z'`

if [ $code1 = 'c' ] ; then
code=`echo $form_arg | cut -c31-32 | tr 'A-Z' 'a-z'`
fi

if [ $code1 = 'd' ] ; then
code=`echo $form_arg | cut -c31-32 | tr 'A-Z' 'a-z'`
if [ $code2 = 'i' ] ; then
code=`echo $form_arg | cut -c31-37 | tr 'A-Z' 'a-z'`
fi
fi
...
echo "<param name=DelayBetweenImages value=200>"

...
# [eg. Write @number = ('1' .. '6') if you want to use files 1.png, 2.png, ..., 6.png.]
# [eg. Write @number = ('0' .. '9') if you want to use files 0.png, 1.png, ..., 9.png.]
@number = ('1' .. '2');
...
# The number of repeats for randomization (integer >= 0)
$r_repeat = 3;

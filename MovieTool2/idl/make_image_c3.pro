...
FUNCTION MAKE_IMAGE_C3, img, hdr, FIXGAPS=fixgaps, VIDEOIMG=videoimg, PICT=pict, NOLABEL=nolabel, NOLOGO=nologo, BKG=bkg
...
;			print, "Image is rolled.  Using rolled background."		;	jake 030717
;			imgm = GETBKGIMG(hdr, mhdr, ALL=model_all, ANY_YEAR=model_any_year, /ffv, /ROLLED);	JAKE ADDED /FFV 030127
;		ENDIF ELSE $
